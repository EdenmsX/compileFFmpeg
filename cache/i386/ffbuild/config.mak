...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=i386 --cc='xcrun -sdk iphonesimulator clang' --as='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch i386 -mios-simulator-version-min=8.0' --extra-ldflags='-arch i386 -mios-simulator-version-min=8.0' --prefix='/Users/liulibin/代码/compileFFmpeg/ffmpeg-iOS/i386'
prefix=/Users/liulibin/代码/compileFFmpeg/ffmpeg-iOS/i386
...
OBJCFLAGS=  
ASFLAGS=  -arch i386 -mios-simulator-version-min=8.0 -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch i386 -mios-simulator-version-min=8.0  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
